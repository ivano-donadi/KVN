...
void alt_generate_hypothesis_launcher(
    at::Tensor direct,     // [tn,vn,2]
    at::Tensor coords,     // [tn,2]
    at::Tensor idxs,        // [hn,vn,2]
...
)
{
    ...
    alt_generate_hypothesis_launcher(direct,coords,idxs, hypo_pts);
}
...
void error_for_hypothesis_launcher(
    at::Tensor direct,     // [tn,vn,2]
    at::Tensor coords,     // [tn,2]
    at::Tensor hypo_pts,   // [hn,vn,2]
    at::Tensor inliers,    // [hn,vn,tn]
...
)
{
    ...
    error_for_hypothesis_launcher(direct,coords,hypo_pts,inliers, thresh, k);
}
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    m.def("alt_generate_hypothesis", &alt_generate_hypothesis, "alt generate hypothesis");
    m.def("voting_for_hypothesis", &voting_for_hypothesis, "voting for hypothesis");
    m.def("error_for_hypothesis", &error_for_hypothesis, "error for hypothesis");
